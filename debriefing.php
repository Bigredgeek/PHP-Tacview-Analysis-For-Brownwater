...
$corePath = tacview_resolve_core_path($config['core_path'] ?? 'php-tacview-core', __DIR__);
...
<html>
	<head>
		...
		// Sticky headers are handled by CSS - no JavaScript needed
		document.addEventListener('DOMContentLoaded', function() {
			console.log('Page loaded - sticky headers enabled via CSS');
		});
		</script>
	</head>
	<body>
